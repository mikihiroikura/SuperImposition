%各種パラメータの読み取り
hscimg_csv_name = 'data/old/20210515_2114_500hz/HSCimg_times.csv';
ledpose_csv_name = 'data/old/20210515_2114_500hz/LEDpose_results.csv';
hsc_pngs = dir('data/old/20210515_2114_500hz/HSC/*.png');
