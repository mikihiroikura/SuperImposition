...
%   
    ...
    video_name = '202104212119_video.mp4';
    ...
    rs0_video_name = '202104231651_video_rs0.mp4';
    ...
    video_name_uavcalib_uavrs = 'UAVRS/202104231651_video_rs1.mp4';
    video_dir_uavcalib_uavrs = strcat(video_folder_uav, video_name_uavcalib_uavrs);
    video_name_uavcalib_ugvrs = 'UGVRS/202104231651_video_rs0.mp4';
    video_dir_uavcalib_ugvrs = strcat(video_folder_uav, video_name_uavcalib_ugvrs);
    csv_name_uavcalib = 'CSV/202104231651_markerpose.csv';
    ...
    video_name_ugv_rs = 'RS/202104231710_video_rs0.mp4';
    video_dir_ugv_rs = strcat(video_folder_ugv, video_name_ugv_rs);
    video_name_ugv_hsc = 'HSC/202104231710_video_hsc.mp4';
    video_dir_ugv_hsc = strcat(video_folder_ugv, video_name_ugv_hsc);
    csv_name_ugv = 'CSV/202104231710_markerpose.csv';
