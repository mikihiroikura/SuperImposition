...
%   
    ...
    video_name_uavcalib_uavrs = 'UAVRS/202105151855_video_rs1.mp4';
    video_dir_uavcalib_uavrs = strcat(video_folder_uav, video_name_uavcalib_uavrs);
    video_name_uavcalib_ugvrs = 'UGVRS/202105151855_video_rs0.mp4';
    video_dir_uavcalib_ugvrs = strcat(video_folder_uav, video_name_uavcalib_ugvrs);
    csv_name_uavcalib = 'CSV/202105151855_markerpose.csv';
    ...
    video_name_ugv_rs = 'RS/202105151840_video_rs0.mp4';
    video_dir_ugv_rs = strcat(video_folder_ugv, video_name_ugv_rs);
    video_name_ugv_hsc = 'HSC/202105151840_video_hsc.mp4';
    video_dir_ugv_hsc = strcat(video_folder_ugv, video_name_ugv_hsc);
    csv_name_ugv = 'CSV/202105151840_markerpose.csv';
